  ...
  <div class="navbar navbar-dark bg-dark shadow-sm">
    <div class="container d-flex justify-content-between">
      <a href="#" class="navbar-brand d-flex align-items-center">
        <strong>CSC 3305 - Data Science</strong>
      </a>
      ...
      <div class="row">
            ...
            <div class="loginPopup">
              ...
              <form method="POST" action="/api/add">
               ...
               <div class="formContainer">
                  ...
                  <input type="text" id="enrolid" placeholder="Code:34" name="enrolid" required>
        ...
        <div class="col-md-4" id="col2">
         <table> 
          <tr>
            <tc> 
              <h3>DATE</h3>30 Mar-5 June
            </tc>
          </tr>
          <tr>
            <tc> 
              <h3><br>SUBJECT</h3>Theory & Programming
            </tc>
          </tr>
          <tr>
            <tc> 
        ...
        <div class="col-md-4" id="col3">
            <h3 id="desc">"A database is an organized collection of structured information, or data, typically stored electronically in a computer system." </h3>
        </div>
      </div>
</footer>
