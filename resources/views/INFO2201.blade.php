  ...
  <div class="navbar navbar-dark bg-dark shadow-sm">
    <div class="container d-flex justify-content-between">
      <a href="#" class="navbar-brand d-flex align-items-center">
        <strong>INFO 2201 - Multimedia Technology</strong>
      </a>
...
<div class="album py-5 bg-light">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="gambaa">
            <img class="bd-placeholder-img card-img-top" width="300" height="250" src="https://industrywired.com/wp-content/uploads/2019/12/Media-and-Entertainment.jpg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: Thumbnail"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"/></img>
          </div>
          <div class="openBtn">
        ...
        <div class="col-md-4" id="col2">
         <table> 
          <tr>
            <tc> 
              <h3>DATE</h3>25 Mar-6 July
            </tc>
          </tr>
          <tr>
            <tc> 
              <h3><br>SUBJECT</h3>Software
            </tc>
          </tr>
          <tr>
            <tc> 
        ...
        <div class="col-md-4" id="col3">
            <h3 id="desc">"In general multimedia is the combination of visual and audio representations. These representations could include elements of texts, graphic arts, sound, animation, and video."  </h3>
        </div>
      </div>
</footer>
