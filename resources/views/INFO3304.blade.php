  ...
  <div class="navbar navbar-dark bg-dark shadow-sm">
    <div class="container d-flex justify-content-between">
      <a href="#" class="navbar-brand d-flex align-items-center">
        <strong>INFO 3304 - E-Commerce</strong>
      </a>
...
<div class="album py-5 bg-light">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="gambaa">
            <img class="bd-placeholder-img card-img-top" width="300" height="250" src="https://melchers-china.com/wp-content/uploads/2020/07/1-1.jpg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: Thumbnail"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"/></img>
          </div>
          <div class="openBtn">
              ...
              <form method="POST" action="/api/add">
               ...
               <div class="formContainer">
                  ...
                  <input type="text" id="userid" placeholder="Your Matric Number" name="userid" required>
                    <label for="enrolid">
                      <strong>Course Code(code:24)</strong>
                    </label>
                  <input type="text" id="enrolid" placeholder="Capslock" name="enrolid" required>
        ...
        <div class="col-md-4" id="col2">
         <table> 
          <tr>
            <tc> 
              <h3>DATE</h3>20 Mar-1 July
            </tc>
          </tr>
          <tr>
            <tc> 
              <h3><br>SUBJECT</h3>Theory & Practical
            </tc>
          </tr>
          <tr>
            <tc> 
        ...
        <div class="col-md-4" id="col3">
            <h3 id="desc">"Ecommerce, also known as electronic commerce or internet commerce, refers to the buying and selling of goods or services using the internet, and the transfer of money and data to execute these transactions."</h3>
        </div>
      </div>
</footer>
