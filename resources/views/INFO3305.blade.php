...
<div class="album py-5 bg-light">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="gambaa">
            <img class="bd-placeholder-img card-img-top" width="300" height="250" src="https://miro.medium.com/max/512/1*GaBtlHe240ZkwlcBrFczgQ.jpeg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: Thumbnail"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"/></img>
          </div>
          <div class="openBtn">
        ...
        <div class="col-md-4" id="col2">
         <table> 
          <tr>
            <tc> 
              <h3>DATE</h3>1 Apr-3 July
            </tc>
          </tr>
          <tr>
            <tc> 
              <h3><br>SUBJECT</h3>Programming
            </tc>
          </tr>
          <tr>
            <tc> 
              <h3><br>DIFFICULTY</h3>Intermediate
            </tc>
          </tr>
          <tr>
            <tc> 
        ...
        <div class="col-md-4" id="col3">
            <h3 id="desc">"A Web application is an application program that is stored on a remote server and delivered over the Internet through a browser interface."</h3>
        </div>
      </div>
</footer>
